...
class PeresActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnext.setOnClickListener {
            if (counter == 0) textview.text =  "- Медведь: когда то давно, крестьяне переселялись на Алтай! Благодаря им Алтайский край разросся, и стал тем что мы знаем сейчас"
            if (counter == 1) textview.text = "- Вы не видите балалайки, осмотритесь по сторонам"
            if (counter == 2) textview.text = "Балалайки нигде нет, до вашего урока остался 1 час, вам следует ускорится"
