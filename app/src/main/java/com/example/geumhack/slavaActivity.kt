...
class slavaActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnext.setOnClickListener {
            if (counter == 0) textview.text =  "- Медведь: емориал включает в себя четыре архитектурных сооружения. Тематический центр первой линии, обращенной к площади, - бронзовая скульптурная группа «Прощание» (фигуры матери и сына) и стела на гранитном постаменте."
            if (counter == 1) textview.text = "У вас осталось 15 минут до занятия, вы говорите об этом расстроеному медведю"
            if (counter == 2) textview.text = "Медведь: что же я буду делать без своей балалайки, но коли уж ты помог мне, пошли в твой кванториум, все равно делать нечего"
            if (counter == 3) textview.text =  "- Медведь: *разачарованно выдыхает*"
            if (counter == 4) {
